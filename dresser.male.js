...
export default class DresserMale extends React.Component {
    ...
    //     });
            ...
            this.sendpostMessage(JSON.stringify({compressed:photo.base64,original:photo.base64}));
    ...
    background-position: center;
        ...
        <div id="coverScreen"  class="LockOn">
                ...
                <canvas id="canvas" style='border: 0px solid black; background-color: transparent;'></canvas>
